...
$menu = mysqli_query($db_conn, "SELECT bayar_penjualan.*, penjualan.kode_transaksi AS kode_penjualan, bayar_penjualan_detail.nama_pelanggan, bayar_penjualan_detail.tanggal_jual, bayar_penjualan_detail.jatuh_tempo FROM `bayar_penjualan` JOIN bayar_penjualan_detail ON bayar_penjualan_detail.kode_transaksi2=bayar_penjualan.kode_transaksi JOIN penjualan ON penjualan.kode_transaksi=bayar_penjualan_detail.kode_penjualan WHERE bayar_penjualan.sisa!=0 GROUP BY bayar_penjualan.kode_transaksi ORDER BY bayar_penjualan.seq DESC");
