...
$headers = apache_request_headers();
        ...
        if(
            ...
            $init = $nama[0];
            $kode = $nama[0];
            $getCode = mysqli_query($db_conn, "SELECT kode FROM `sopir` WHERE nama LIKE '$init%' ORDER BY kode DESC LIMIT 1");
            ...
            $insert = mysqli_query($db_conn, "INSERT INTO `sopir`(`kode`, `nama`, `alamat`, `kota`, `telepon`, `fax`) VALUES ('$kode','$nama','$alamat','$kota','$telepon','$fax')");
            if ($insert) {
