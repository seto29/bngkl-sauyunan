...
<body>
    ...
    <?php
        ...
        header("Content-Disposition: attachment; filename=Laporan_Kanvas_SALES\"$str\".xls");
        ...
        $list = mysqli_query($db_conn, "SELECT * FROM `kanvas` WHERE tanggal_ambil>='$time1' AND tanggal_ambil<='$time2' ORDER BY kode_sales");
        $i=1;
        $array = array();
  ...
  <br/>
        ...
        foreach ($array as $value) {
            if($first==false && $temp!=$value['kode_sales'] ){
                ?>
        ...
        <table border="1">
            ...
            <tr >
                ...
                <td colspan="12s">
                    Kd: <?php echo $value['kode_sales'];?>, NM <?php echo $value['nama_sales'];?>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <td>
                <b>
                    <?php echo tanggalF($value['tanggal_ambil']);?>
                </b>
            </td>
            <td>
                <b>
